...
export function mockupPreviewPlugin() {
  ...
  function generateSource(components) {
    const entries = components.map(c => `  ${JSON.stringify(c.globKey)}: () => import(${JSON.stringify(c.importPath)})`).join(",\n");
    return ["// This file is auto-generated by mockupPreviewPlugin.ts.", "type ModuleMap = Record<string, () => Promise<Record<string, unknown>>>;", "export const modules: ModuleMap = {", entries, "};", ""].join("\n");
  }
