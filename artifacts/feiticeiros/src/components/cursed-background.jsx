...
export function CursedBackground({
  ...
  return /*#__PURE__*/_jsxs("div", {
    ...
    children: [/*#__PURE__*/_jsx("div", {
      className: "absolute inset-0 bg-cursed-grid opacity-30"
    }), /*#__PURE__*/_jsx("div", {
      className: "absolute inset-0",
      style: {
        background: "radial-gradient(ellipse 80% 55% at 50% 25%, transparent 0%, hsl(260 30% 3% / 0.55) 75%, hsl(260 40% 2%) 100%)"
      }
    }), /*#__PURE__*/_jsx("div", {
    ...
    }), particles.map((p, i) => /*#__PURE__*/_jsx("span", {
      ...
      style: {
        background: "radial-gradient(circle, hsl(265 85% 50% / 0.30), transparent 70%)"
      }
    }), /*#__PURE__*/_jsx("div", {
      className: "absolute -right-40 bottom-0 w-[520px] h-[520px] rounded-full blur-[110px] animate-domain",
      style: {
        background: "radial-gradient(circle, hsl(355 80% 45% / 0.22), transparent 70%)",
        animationDelay: "2s"
      }
    }), /*#__PURE__*/_jsx("div", {
      className: "absolute -top-64 left-1/2 -translate-x-1/2 w-[600px] h-[400px] rounded-full blur-[90px] animate-domain",
      style: {
        background: "radial-gradient(ellipse, hsl(275 90% 55% / 0.18), transparent 65%)",
        animationDelay: "4s"
      }
    })]
  });
